...
input_dir <- "C:/Users/sunlab/OneDrive - University of Wyoming/Reversal paper/Reversal paper/Data/Reversal_normal_disease_alldata"
...
df_PERCS <- data.frame(
  ...
  P = NA, E = NA, R = NA, C = NA, S = NA, Pellet = NA
)
